...
class _BodyState extends State<Body> {
  ...
  getSlotsByBusinessAndService(String date) async {
    Map<String, String>? result = await ApiCalls.getSlotsByBusinessAndService(
        widget.business!.businessId!, widget.service!.serviceName!,date,context.read<UserProvider>().users.userId!);
  ...
  createBookingServices(String date) async {
    ...
    Map<String, String>? result = await ApiCalls.createBookingServices(widget.business!,context.read<UserProvider>().users.userId!,date, widget.service!,slotNumber!,time!,totalAmount,instructions,rating!);
    if (result?["error"] == null) {
      showDialog(
          context: context,
          barrierDismissible: false,
          builder: (context)=>CustomDialog(
            ...
            onFirstPressed: (){
              ...
              Navigator.of(context).pushNamedAndRemoveUntil(TabsScreen.routeName, (Route<dynamic> route) => false);
            },));
      setState(() {
        _processing = false;
      });
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.service?.discountedPrice == null || widget.service?.discountedPrice == 0){
      setState(() {
                    ...
                    children: [
                      Container(
                        ...
                        child: CarouselSlider.builder(
                          itemCount: widget.service!.listImagePath == null ? slider.length : widget.service!.listImagePath!.length,
                          ...
                          itemBuilder: (context, index, realIndex) {
                            ...
                            return ClipRRect(
                              ...
                              child:(widget.service!.listImagePath !=null && (widget.service!.listImagePath!.isNotEmpty))
                                ...
                                imageUrl: "${env.config?.imageUrl}${(widget.service!.listImagePath![index])}",
                                fit: BoxFit.fill,
                              )
                                  :Image.asset(
                                "${image.image}",
                      ...
                      Padding(
                        ...
                        child: AnimatedSmoothIndicator(
                          ...
                          count: widget.service!.listImagePath == null ? slider.length : widget.service!.listImagePath!.length,
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              (widget.service?.discountedPrice == null || widget.service?.discountedPrice == 0) ? Text(
                      ...
                      Stack(
                        children: [
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            ...
                                            child: TextButton.icon(
                                                icon: SvgPicture.asset('assets/Icons/date.svg',width: 10,),
                                                label:  Text(DateFormat.yMMMd().format(date),style: GoogleFonts.poppins(fontSize: 12,color: blueGrey),),
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    SizedBox(
                                                        ...
                                                        child: Text('Select',style: GoogleFonts.poppins(color: blueGrey,fontWeight: FontWeight.w600),textAlign: TextAlign.center,)),
                                                    SizedBox(
                                                        width: getProportionateScreenWidth(90),
                                                        child: Text('Time',style: GoogleFonts.poppins(color: blueGrey,fontWeight: FontWeight.w600),textAlign: TextAlign.center,)),
                                                    SizedBox(
                                                        width: getProportionateScreenWidth(70),
                                                        child: Text('Available',style: GoogleFonts.poppins(color: blueGrey,fontWeight: FontWeight.w600),textAlign: TextAlign.center,)),
                                                    SizedBox(
                                                        width: getProportionateScreenWidth(60),
                                                        child: Text('Booked',style: GoogleFonts.poppins(color: blueGrey,fontWeight: FontWeight.w600),textAlign: TextAlign.center,)),
                                                  ],
                                                ),
                                                slots.isEmpty ? SizedBox(
                                                  height: getProportionateScreenHeight(100),
                                                child: Center(child: Text('No Slots Right Now',style: GoogleFonts.poppins(),),),) : SizedBox(
                                                  ...
                                                  child: ListView.builder(
                                                      ...
                                                      itemBuilder: (context,index){
                                                        return Opacity(
                                                          opacity: ((slots[index].bookedByUser!)||slots[index].totalAvailable==0) ? 0.3 : 1.0,
                                                          child: Row(
                                                            children: [
                                                              SizedBox(
                                                                ...
                                                                child: Radio(
                                                                  ...
                                                                  groupValue:time,
                                                                  onChanged: (!(slots[index].bookedByUser!)||slots[index].totalAvailable!=0) ? (TimeObj? value) {
                                                              ...
                                                              SizedBox(
                                                                  ...
                                                                  child: Text('${DateFormat('h:mm:a').format(DateTime.parse(slots[index].timeObj!.startTime!))} - ${DateFormat('h:mm:a').format(DateTime.parse(slots[index].timeObj!.endTime!))}',style: GoogleFonts.poppins(color: blueGrey,fontWeight: FontWeight.w600,fontSize: 10),textAlign: TextAlign.center,)),
                                                              SizedBox(
                                                                  width: getProportionateScreenWidth(90),
                                                                  child: Text('${slots[index].totalAvailable}',style: GoogleFonts.poppins(color: blueGrey,fontWeight: FontWeight.w600,fontSize: 10),textAlign: TextAlign.center,)),
                                                              SizedBox(
                                                                  width: getProportionateScreenWidth(60),
                                                                  child: Text('${slots[index].totalBooked}',style: GoogleFonts.poppins(color: blueGrey,fontWeight: FontWeight.w600,fontSize: 10),textAlign: TextAlign.center,)),
                                                            ],
                                                          ),
                                                        );
                                                      }),
                          ...
                          isCalendarOpen ? isInfoBoxOpen ?  Card(
                                    ...
                                    children: <Widget>[
                                      ...
                                      SizedBox(
                                        ...
                                        child: Text(DateFormat.yMMMd().format(date),
                                            ...
                                            style: GoogleFonts.poppins(
                                                fontSize: 16, color: blueGrey,fontWeight: FontWeight.w600),),
                                      ),
                                      Container(
                                          width: cellWidth/1.8,
                                          height: cellWidth/1.8,
                                ...
                                SfDateRangePicker(
                                  ...
                                  monthViewSettings: DateRangePickerMonthViewSettings(
                                    ...
                                    viewHeaderStyle: DateRangePickerViewHeaderStyle(
                                      textStyle: GoogleFonts.poppins(color: blueGrey,fontWeight: FontWeight.w600),
                                    ),),
                                  monthCellStyle: DateRangePickerMonthCellStyle(
                                      leadingDatesTextStyle: GoogleFonts.poppins(color: grey,fontWeight: FontWeight.w600),
                                      textStyle: GoogleFonts.poppins(color: orange,fontWeight: FontWeight.w600),
                                      trailingDatesTextStyle: GoogleFonts.poppins(color: grey,fontWeight: FontWeight.w600)),
                          ...
                          ) : SizedBox(height: 0.0,width: 0.0,) : SizedBox(height: 0.0,width: 0.0,)
                        ],
                      ),
                    SizedBox(
                          width: double.infinity,
                          child: CustomButton(
                            ...
                            onPressed: (){
                            createBookingServices(DateFormat("yyyy-MM-dd").format(date));
