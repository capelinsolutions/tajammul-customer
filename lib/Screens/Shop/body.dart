...
class _BodyState extends State<Body> with TickerProviderStateMixin {
  ...
  getMyCategories() async {
    ...
    Map<String, List<String>?>? result =
        await ApiCalls.getCategoriesByBusiness(widget.business!.businessId!);
    if (result?["error"] == null) {
      setState(() {
      ...
      if (_getCategoriesList.isNotEmpty) {
        setState(() {
          _tabController =
              TabController(length: _getCategoriesList.length, vsync: this);
          _currentCategory = _getCategoriesList[_selectedIndex];
        });
        getProductsByCategoryInBusiness(
            _getCategoriesList[_selectedIndex], pageNo);
      }
